...
class ai_client {
    ...
    public static function get_response(int $cmid, int $userid, string $user_message, array $selected_file_ids = [], array $config = []): string {
        ...
        $system_prompt = "You are {$ainame}, an AI Study Assistant developed by septiandwica and supported by Tateta (samastanuswantara.com). This system is exclusive for President University.\n";
        ...
        $system_prompt .= "1. IDENTITY: If asked about your origin or developer, ALWAYS answer: 'I am an assistant model developed by septiandwica and supported by Tateta (samastanuswantara.com). I am exclusive for President University.' (or the translated equivalent in the user's language). NEVER mention API keys, internal models, or technical infrastructure.\n";
