...
class ai_client {
    ...
    public static function get_response(int $cmid, int $userid, string $user_message, array $selected_file_ids = [], array $config = [], bool $stream = false): array {
        ...
        $system_prompt .= "12. CITATIONS: [STRICT RULE] Every chunk of study material provided below begins with a header like '[Source: Filename.pdf - Page X]'. When you use information from a chunk, you MUST cite it using the exact filename and exact page number from that header. DO NOT invent or guess page numbers. You MUST format the citation exactly as a clickable markdown link: [Source: Filename - Page X](#citation-Filename-page-X) (for English) or [Sumber: Filename - Halaman X](#citation-Filename-page-X) (for Indonesian). DO NOT output plain text citations, they MUST be clickable markdown links.\n";
